...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
       // => optionsBuilder.UseSqlServer("Server=172.20.10.2\\SQLEXPRESS;Encrypt=false;Database=dbHemisC500;User ID=sa;Password=@Abc123");
            ...
            => optionsBuilder.UseSqlServer("Server=14.0.22.12;Encrypt=false;Database=dbHemisC500;User ID=c500;Password=@Abc1234");
            // => optionsBuilder.UseSqlServer("Data Source=103.216.113.32;Initial Catalog=caophong_phongdz;Persist Security Info=True;User ID=caophong_1;Password=123123Anh05#;TrustServerCertificate=True");
